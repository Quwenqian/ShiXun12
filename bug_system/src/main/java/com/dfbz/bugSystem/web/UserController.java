...
public class UserController {
    ...
    public Object findUserById(@RequestParam("id") Integer id){
        ...
        //访问Project项目接口并获得返回数据
        String result = restTemplate.getForEntity("http://127.0.0.1:8091/bug/project/showProject",String.class).getBody();
        System.out.println(result+" from project module");
